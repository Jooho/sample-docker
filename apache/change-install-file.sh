...
do
        ...
        then
                ...
                if [[ z$c_old == z ]]; then
                        echo usage : -old=jboss-eap-6.2.0.zip -new=jboss-eap-6.3.0.Beta.zip
                        exit 1
                else
                        OLD_FILE_NAME=$c_old
                fi
